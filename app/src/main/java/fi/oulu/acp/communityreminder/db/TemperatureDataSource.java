...
public class TemperatureDataSource {
    ...
    private String[] allColumns = { MySQLiteHelper.COLUMN_ID,
            MySQLiteHelper.COLUMN_SESSION, MySQLiteHelper.COLUMN_PERFORMANCE,
            MySQLiteHelper.COLUMN_ENV_TEMP, MySQLiteHelper.COLUMN_TEMP};
    ...
    public int addTempData(int session, String performance, String envTemp, float temp) {
        ...
        values.put(MySQLiteHelper.COLUMN_PERFORMANCE, performance);
        values.put(MySQLiteHelper.COLUMN_ENV_TEMP, envTemp);
        values.put(MySQLiteHelper.COLUMN_TEMP, temp);
